...
# здесь строчку с первым многочленом склеить (сложить) со строкой второго многочлена
# но нужно постараться по другому сделать
# слева от икс квадртат - коэфиициент а
...
f = open('Task-04-05-1.txt', 'w')
f.write(nmnogochlen1())
print(nmnogochlen1())
f.close()

f = open('Task-04-05-2.txt', 'w')
f.write(nmnogochlen2())
print(nmnogochlen2())
f.close()

f = open('Task-04-05-1.txt', 'r')
